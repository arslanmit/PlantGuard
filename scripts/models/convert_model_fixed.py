...
def convert_model(input_path, output_path) -> Any:
    ...
    converted_checkpoint = {
        ...
        "config": {"num_classes": checkpoint["num_classes"], "model_architecture": "resnet50"},
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="data/models/converted_model_fixed.pt", help="Path to save the converted model")
