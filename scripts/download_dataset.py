...
class DatasetDownloader:
    ...
    def __init__(self, data_dir: str = "data", use_kaggle_api: bool = True):
        ...
        self.dataset_info = {
            ...
            "total_images": 87863,
            "validation_files": [
                "plantvillage_dataset/train",
                "plantvillage_dataset/val", 
                "plantvillage_dataset/test"
            ]
        }
    ...
    def check_kaggle_setup(self) -> Dict[str, Any]:
        ...
        try:
            ...
            result["error"] = f"Kaggle setup error: {str(e)}"
    ...
    def download_with_kaggle_api(self) -> Dict[str, Any]:
        ...
        try:
            ...
            kaggle.api.dataset_download_files(
                self.dataset_info['kaggle_dataset'],
            ...
            result["error"] = str(e)
            result["message"] = f"Kaggle API download failed: {str(e)}"
    ...
    def download_direct_url(self, url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            result["error"] = str(e)
            result["message"] = f"Direct download failed: {str(e)}"
            logger.error(result["message"])
    ...
    def validate_dataset(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Validation criteria
            if (result["structure_check"] and 
                result["classes_found"] >= 30 and  # Expect ~38 classes
                result["file_count"] >= 50000):     # Expect ~87k images
                result["valid"] = True
    ...
    def prepare_dataset_structure(self) -> Dict[str, Any]:
        ...
        try:
            ...
            result["error"] = str(e)
            result["message"] = f"Dataset preparation failed: {str(e)}"
            logger.error(result["message"])
            
        return result
    
    def download_and_prepare(self, fallback_url: Optional[str] = None) -> Dict[str, Any]:
...
def main():
    ...
    downloader = DatasetDownloader(
        ...
        use_kaggle_api=not args.no_kaggle
    )
