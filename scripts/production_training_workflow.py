...
class ProductionWorkflow:
    ...
    def _validate_dataset(self) -> Tuple[bool, List[str]]:
        ...
        if processed_train.exists() and processed_val.exists():
            ...
            try:
                validation_result = self.dataset_manager.validate_dataset(
            ...
            errors.append(
                "No suitable dataset found. Please run one of:\n"
    ...
    def run_production_training(self, config: TrainingConfig) -> bool:
        ...
        try:
            ...
            monitor = TrainingMonitor(
                ...
                log_dir=Path("runs") / config.experiment_name
            )
