...
class MobileImageAnalysis(MobileComponent):
        ...
        return ComponentMetadata(
            ...
            test_scenarios=[
                ...
                },
                {
                    ...
                    'description': 'Test analysis execution',
                    'expected_outcome': 'Analysis runs and returns results'
                },
                {
    ...
    def render_image_upload_section(self) -> Optional[Image.Image]:
        ...
        with camera_tab:
            ...
            camera_image = st.camera_input(
                "Take a photo",
                key=f"{self.component_id}_camera",
                help="Take a clear photo of the plant leaves"
            )
    ...
    def perform_analysis(self, image: Image.Image) -> Dict[str, Any]:
        ...
        if not self.vision_adapter:
            return {
                'error': 'Vision adapter not initialized',
                'success': False
            }
        ...
        try:
            ...
            try:
                raw_class, readable_name, confidence_score, plant_type = \
                    self.vision_adapter.predict_with_readable_name(image)
    ...
    def render(self, **kwargs) -> Dict[str, Any]:
        ...
        # Main container
        st.markdown('<div class="mobile-image-analysis" data-component="mobile-image-analysis" data-testable="true">', 
                   unsafe_allow_html=True)
    ...
    def get_analysis_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'last_analysis_success': st.session_state.get('analysis_results', {}).get('success', False) if st.session_state.get('analysis_results') else None,
...
def create_mobile_image_analysis(model_manager=None, max_image_size=(1024, 1024)) -> MobileImageAnalysis:
    ...
    return MobileImageAnalysis(
        component_id="mobile_image_analysis",
