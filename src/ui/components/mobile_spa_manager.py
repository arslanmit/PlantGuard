...
class MobileSPAManager(MobileComponent):
    ...
    def _get_component_metadata(self) -> ComponentMetadata:
        ...
        return ComponentMetadata(
            ...
            state_dependencies=["focused_content", "content_areas_initialized", "spa_mode_active"],
            css_classes=["mobile-spa-container", "mobile-content-section", "mobile-focus-indicator"],
            test_scenarios=[
                {
    ...
    def register_content_area(self, area_id: str, title: str, icon: str, callback: Callable) -> None:
        ...
        self.content_areas[area_id] = {"id": area_id, "title": title, "icon": icon, "callback": callback, "enabled": True}
    ...
    def safe_button_click(self, button_id: str, action: Callable) -> bool:
        ...
        clicked = st.button(label=button_id, key=button_key, use_container_width=True)
