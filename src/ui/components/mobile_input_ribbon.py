...
class MobileInputRibbon(MobileComponent):
    ...
    def _get_component_metadata(self) -> ComponentMetadata:
        ...
        return ComponentMetadata(
            ...
            state_dependencies=[
                'active_input_mode',
                'input_ribbon_initialized',
                'camera_available',
                'microphone_available'
            ],
            css_classes=[
                'mobile-input-ribbon-always-visible',
                'mobile-input-section-header',
                'mobile-input-status-overview'
            ],
            test_scenarios=[
                {
    ...
    def get_active_input_mode(self) -> Optional[str]:
...
# Utility functions
def create_mobile_input_ribbon(layout_style: str = 'grid',
                              show_labels: bool = True,
                              button_style: str = 'elevated') -> MobileInputRibbon:
    """Create and return a MobileInputRibbon instance."""
    return MobileInputRibbon(
        component_id="mobile_input_ribbon",
